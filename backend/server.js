...
app.get(['/api/memory/:memoryId', '/memory/:memoryId'], async (req, res) => {
    ...
    try {
        ...
        console.log(`📖 Loading gallery ${memoryId}:`, {
...
app.put(['/api/memory/:memoryId', '/memory/:memoryId'], async (req, res) => {
    ...
    try {
        console.log(`📝 Updating gallery ${memoryId}:`, {
        ...
        console.log(`✅ Gallery ${memoryId} updated successfully`);
...
app.post(['/api/verify-passcode', '/verify-passcode'], async (req, res) => {
    ...
    try {
        ...
        if (!data.passcodeHash) {
            ...
            console.log(`⚠️ No passcode set for ${memoryId}`);
        ...
        console.log(`🔒 Passcode verification for ${memoryId}: ${isValid ? '✅ Valid' : '❌ Invalid'}`);
...
app.post(['/api/upload-image', '/upload-image'], async (req, res) => {
    ...
    try {
        console.log(`📤 Uploading image to R2 for ${memoryId}...`);
